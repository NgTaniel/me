...
def greet(name="Towering Timmy") -> str:
    ...
    """
    greet_phrase = "Well hello, "
    final_greeting = greet_phrase + name
...
def set_it_on_fire(input_string="very naughty boy") -> str:
    ...
    """
    new_string = list(str(input_string).upper())
    new_shout = "🔥" + str("🔥".join(new_string)) + "🔥"
    return new_shout
